...
function getSessionId(): string {
  // TODO: cuando exista el paquete @core/session (sesión compartida entre
  // market.core.com.uy y la futura landing IG), volver a usar cookie acá.
  // Por ahora, localStorage simple para no depender de algo que no existe
  // todavía en el repo real.
